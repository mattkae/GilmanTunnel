...
void Gallery::Update(CrossedState state) {
	...
	bool before = this->m_isActive;
	this->m_isActive = (this->m_current != CrossedState_False) && (this->m_before == CrossedState_True);
	...
	} else if (before == false && this->m_isActive == true) {
